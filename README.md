...
&emsp;&emsp;技术交流：@jason770612 ，使用过程遇到的问题也可在git上及时反馈，版本更新时会实时解决。  
## 2、更新记录  
...
&emsp;&emsp;2023-01-06 适配微信版本3.8.1.26。  
&emsp;&emsp;2023-01-17 下载地址恢复。  
&emsp;&emsp;2023-02-26 适配微信版本3.9.0.28。  
&emsp;&emsp;2023-03-04 提供SDK。  
&emsp;&emsp;2023-03-11 禁用自动升级。  
&emsp;&emsp;2023-04-06 适配微信最新版本3.9.2.23，解决消息丢失的问题，新好友设置上的一系列问题。  
&emsp;&emsp;2023-04-10 解决拖动窗口位置错位的问题。  
&emsp;&emsp;2023-05-11 解决内存泄漏及若干性能问题。  
&emsp;&emsp;2023-05-15 解决接收消息偶发崩溃。3.9.2.23微信版本请重新下载微信工作助手并安装。  
&emsp;&emsp;2023-05-20 解决个人数据读取失败的问题。  
&emsp;&emsp;2023-05-24 解决收到群主更换消息崩溃，僵尸粉清理等若干问题。  

&emsp;&emsp;实时更新中...  
## 3、下载  
&emsp;&emsp;下载前请查看电脑安装的微信版本，选择正确的Wechatplus版本下载，由于处于不断修复过程中，历史版本使用中如有问题最好升级到最新版本：  
...
&emsp;&emsp;3、如果电脑装有杀毒软件，在安装过程或者安装完成后将报警的文件添加到信任区或者退出杀毒软件，为避免后续杀毒软件误报，请将wechatplus安装目录和微信的安装目录都及时添加到杀毒软件的信任区   
